...
public:
    ...
    void imuHandler(const sensor_msgs::Imu::ConstPtr& imuMsg)
    {
        ...
        cout << "roll: " << imuRoll*180/M_PI << ", pitch: " << imuPitch*180/M_PI << ", yaw: " << imuYaw*180/M_PI << endl << endl;
    }
    ...
    bool cachePointCloud(const sensor_msgs::PointCloud2ConstPtr& laserCloudMsg)
    {
        ...
        // pcl::PointCloud<PointXYZIRT>::Ptr jxx;
        
        // jxx.reset(new pcl::PointCloud<PointXYZIRT>());
        pcl::fromROSMsg(currentCloudMsg, *laserCloudIn);

        // Remove Nan points
        // std::vector<int> indices;
        // pcl::removeNaNFromPointCloud(*jxx, *laserCloudIn, indices);
